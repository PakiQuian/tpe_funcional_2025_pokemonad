...
drawTeamSelectScreen menuBgImage logoImage selectedId team spriteMap = pictures 
    [ menuBgImage                      
    , drawLogo logoImage               
...
drawSelectionBox selectedId team spriteMap = pictures
...
drawTeamGrid team spriteMap = pictures
...
drawSlots team spriteMap = pictures
...
drawTeamSlot spriteMap team index xPos yPos = translate xPos yPos $ pictures
