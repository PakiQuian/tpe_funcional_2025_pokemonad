...
import Pokemonad.Core.Types (PokemonType (..))
...
allMoves =
  [ -- NORMAL MOVES (PHYSICAL)
    ...
    mkMove "Horn Drill" Normal Physical 1 30 5,
    mkMove "Guillotine" Normal Physical 1 30 5,
    ...
    mkMove "Bide" Normal Physical 1 100 10,
    ...
    mkMove "Swift" Normal Special 60 100 20,
    ...
    mkMove "Solarbeam" Grass Special 120 100 10,
    ...
    -- FIGHTING MOVES
    mkMove "Counter" Fighting Physical 1 100 20,
    mkMove "Seismic Toss" Fighting Physical 1 100 20,
    mkMove "Submission" Fighting Physical 80 80 20,
    mkMove "Double Kick" Fighting Physical 30 100 30,
    mkMove "Low Kick" Fighting Physical 50 100 20,
    ...
    mkMove "Fissure" Ground Physical 1 30 5,
    -- FLYING MOVES
    ...
    -- GHOST MOVES
    mkMove "Night Shade" Ghost Special 1 100 15,
    ...
    mkMove "Dragon Rage" Dragon Special 1 100 10,
    -- DARK MOVES
...
getMoveByName name =
  case filter (\m -> moveName m == name) allMoves of
    (x : _) -> x
